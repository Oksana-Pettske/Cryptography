...
uint32_t simon_encrypt_48(uint8_t round_limit, uint8_t *key_sched, uint8_t *plaint_text, uint8_t *cipher_text);
uint32_t simon_encrypt_64(uint8_t round_limit, uint8_t *key_sched, uint8_t *plaint_text, uint8_t *cipher_text);
uint32_t simon_encrypt_96(uint8_t round_limit, uint8_t *key_sched, uint8_t *plaint_text, uint8_t *cipher_text);
uint32_t simon_encrypt_128(uint8_t round_limit, uint8_t *key_sched, uint8_t *plaint_text, uint8_t *cipher_text);
